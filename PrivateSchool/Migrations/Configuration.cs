...
namespace PrivateSchool.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<MyDatabase>
    {
        ...
        protected override void Seed(MyDatabase context)
        {
            ...
            var a4 = new Assignment() { Title = "ProjectPython", Description = "Individual", SubDate = new DateTime(2021, 9, 17), OralMark = 50, TotalMark = 100, Courses = new Collection<Course>() { c4, c5 } };
            var a5 = new Assignment() { Title = "Database", Description = "Group", SubDate = new DateTime(2021, 4, 7), OralMark = 30, TotalMark = 100, Courses = new Collection<Course>() { c1, c2, c3, c4, c5 } };
